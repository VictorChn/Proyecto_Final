...
<head>
    <meta charset="utf-8">
    <title>Confirmación de tu Cita - GIO & ANGIE</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>¡Hola, <strong>{{ $clientName }}</strong>! Tu cita en <strong>GIO & ANGIE</strong> ha sido programada con éxito.</p>
            ...
            <p>Te esperamos en el salón. Si necesitas reagendar o cancelar, por favor inicia sesión en nuestra plataforma con anticipación. ¡Que tengas un excelente día!</p>
        </div>
        <div class="footer">
